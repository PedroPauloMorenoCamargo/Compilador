...
class SymbolTable:
    def __init__(self):
        # Dicionário para armazenar as variáveis com seus tipos e offsets
        self.symbols = {}
        self.current_offset = 0  # Track current EBP offset (starts at 0)
    ...
    def set(self, name, value_type):
        # Define o valor e o offset da variável
        self.symbols[name] = (self.current_offset, value_type)
        self.current_offset += 4  # Move the offset for the next variable (assuming 4 bytes per variable)
